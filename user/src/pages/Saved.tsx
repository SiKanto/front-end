...
export default function Saved() {
  ...
  return (
    <>
      ...
      <section className={`saved-page scroll-fade ${pageVisible ? "visible" : ""}`}>
        <h2 className="saved-title scroll-fade">Your Favorite Places</h2>
        {savedPlaces.length === 0 ? (
          <p className="empty-message scroll-fade">You haven’t saved any places yet.</p>
        ) : (
